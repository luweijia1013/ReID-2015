...
class NumpyArrayIterator_for_Market1501(pre_image.Iterator):
    ...
    def __init__(self, f, path_list, user_name, train_or_validation = 'train', flag = 0, image_data_generator = None,
                 batch_size=75, shuffle=True, seed=1217,
        ...
        self.folder_dir = '/home/' + user_name + '/market-1501/boundingbox' + train_or_validation + '/'
...
class ImageDataGenerator_for_multiinput(pre_image.ImageDataGenerator):
    ...
    def flow(self, f, path_list, user_name, train_or_validation = 'train', flag = 0, batch_size=75, shuffle=True, seed=1217):
...
def train(model,weights_name='weights_on_market1501_0_0',train_num=20,one_epoch=30000,epoch_num=1,flag_random=False,random_pattern=lambda x:x/2+0.5, flag_train=0,flag_val=1,nb_val_samples=1000,user_name='workspace'):
    with h5py.File('market1501_positive_index.h5','r') as f:
        ...
        for i in xrange(train_num):
            ...
            print Rank1s
            model.save_weights('weights_20trainnum/'+weights_name+'_'+str(i)+'.h5')
        return Rank1s
